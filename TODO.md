...
- [x] Step 4: Copy files to MLproject/ (MLproject, conda.yaml, modelling.py, modelling_tuning.py, preprocessed_corn_data.csv, X*.csv, y*.csv)
- [x] Step 5: Copy/move files to monitoring & logging/ (inference.py, prometheus_exporter.py, prometheus-corn.yml)
- [x] Step 6: Verify structure with tree / dir listing
- [x] Step 7: Optional cleanup (delete originals if desired), git add/commit
